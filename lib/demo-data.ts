...
export const demoNodes: KnowledgeNode[] = [
  ...
  },
  {
    ...
    description: 'Understanding data shapes including normal distribution, skewness, kurtosis, and normality testing',
    bloom_level: 'understand',
    difficulty: 'intermediate',
    parent_module_id: 'module-demo-3',
    source: 'ai_extracted',
  ...
  },
  {
    ...
    description: 'Using Pandas groupby operations to summarize and analyze data subsets',
    bloom_level: 'apply',
    difficulty: 'intermediate',
    parent_module_id: 'module-demo-3',
    source: 'ai_extracted',
  ...
  },
  {
    ...
    description: 'Generating testable hypotheses from exploratory data patterns',
    bloom_level: 'analyze',
    difficulty: 'intermediate',
    parent_module_id: 'module-demo-3',
    source: 'ai_extracted',
...
export const demoEdges: KnowledgeEdge[] = [
  ...
  // Module 3 enhanced connections
  {
    ...
    strength: 'required',
    confidence: 0.9,
    rationale: 'Understanding measures of center and spread is needed before analyzing distribution shapes',
    source_type: 'ai_extracted',
    confirmed: true,
  },
  {
    ...
    strength: 'required',
    confidence: 0.95,
    rationale: 'Need DataFrame skills before using groupby operations',
    source_type: 'ai_extracted',
    confirmed: true,
  },
  {
    ...
    strength: 'recommended',
    confidence: 0.85,
    rationale: 'Understanding distributions helps formulate valid hypotheses',
    source_type: 'ai_extracted',
    confirmed: true,
  },
  {
    ...
    strength: 'recommended',
    confidence: 0.85,
    rationale: 'Correlation patterns inform hypothesis formulation',
    source_type: 'ai_extracted',
    confirmed: true,
  },
  {
    ...
    strength: 'required',
    confidence: 0.9,
    rationale: 'Formulating hypotheses precedes testing them',
    source_type: 'ai_extracted',
    confirmed: true,
  },
]
